...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/votca-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/votca-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `votca` available on your platform:
...
```
pixi search votca --channel conda-forge
```
